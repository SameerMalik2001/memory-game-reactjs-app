...
import i1 from '../Assets/Easy/1.jpg'
import i2 from '../Assets/Easy/2.jpg'
import i3 from '../Assets/Easy/3.jpg'
import i4 from '../Assets/Easy/4.jpg'
...
function Easy() {
  let data_1 = [
    ...
    { index: 5, id: 4, img: i4, solid: false, state: false },
    { index: 6, id: 3, img: i3, solid: false, state: false },
    { index: 7, id: 2, img: i2, solid: false, state: false },
    { index: 8, id: 1, img: i1, solid: false, state: false },
  ]
  shuffleArray(data_1)
