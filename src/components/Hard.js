...
import i1 from '../Assets/Hard/1.jpg'
import i2 from '../Assets/Hard/2.jpg'
import i3 from '../Assets/Hard/3.jpg'
import i4 from '../Assets/Hard/4.jpg'
import i5 from '../Assets/Hard/5.jpg'
import i6 from '../Assets/Hard/6.jpg'
import i7 from '../Assets/Hard/7.jpg'
import i8 from '../Assets/Hard/8.jpg'
...
function Hard() {
    let data_1 = [
        ...
        { index: 13, id: 7, img: i7, solid: false, state: false },
        { index: 14, id: 8, img: i8, solid: false, state: false },
        { index: 15, id: 7, img: i7, solid: false, state: false },
        { index: 16, id: 8, img: i8, solid: false, state: false },
    ]
    shuffleArray(data_1)
